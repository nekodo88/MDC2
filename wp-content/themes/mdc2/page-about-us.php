...
<section id="reports" class="align-center">
    ...
    <div class="row">
        <a href="/mdc2/aktualnosci/raport-sladu-weglowego-mdc2-za-rok-2023-opublikowany/" class="btn outline medium icon-right icon-down">Pobierz Raport Roczny</a>
        <a href="/mdc2/wp-content/uploads/2024/09/About-MDC2_EN_Website.pdf" class="btn outline medium icon-right icon-down">Pobierz Broszurę o MDC<sup>2</sup></a>
    </div>
</section>
